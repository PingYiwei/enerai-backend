...
from app.modules.auth.model_settings import read_model_settings, write_model_settings
...
async def model_settings(
    ...
    return await read_model_settings(database, principal.user_id, settings)
...
async def update_model_settings(
    ...
    return await write_model_settings(database, principal.user_id, body, settings)
